...
mainApp.controller('MainController', ["$scope", "SharingIsCaring", function($scope, SharingIsCaring) {
    $scope.shared = SharingIsCaring;
}]);

mainApp.controller('AlternateController', ["$scope", "SharingIsCaring", function($scope, SharingIsCaring) {
...
mainApp.controller('AddPropertyController', function($scope, SharingIsCaring) {
    ...
    $scope.reset = function() {
        // SharingIsCaring = {}; //doesn't working
        for(var prop in SharingIsCaring) {
            delete SharingIsCaring[prop];
        }
    };
});
